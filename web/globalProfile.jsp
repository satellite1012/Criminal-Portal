...
<%
    ...
    //CHECK ADMIN
    if (userLogin!=null&&userLogin.getRole()==0){
        isEditable=true;
    }  
    //GET USER SHOW
    ...
    try {
        //FOR PROFILE
        User temp=UserController.userSelected;
        if (temp!=null){
            //CHECK OWN THIS ACCOUNT
            if (userLogin!=null&&temp.getId_user()==userLogin.getId_user()) isEditable=true;
            user=temp;
                            ...
                            <div class="col-lg-4 mb-5">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <c:if test="<%=!isEditable%>">
                                        <p style="font-family:arial;font-size: 17px;">Mật khẩu: <font style="color:red;">bạn không có quyền xem mục này</font></p>
                                        </c:if>
                                        <hr>
